...
class Playlist(Base):
    ...
    # Token do link público (uuid). None = playlist não publicada.
...
class CdComment(Base):
    """Comentário de um usuário num CD (banda) — prova social/engajamento."""

    __tablename__ = "cd_comments"
